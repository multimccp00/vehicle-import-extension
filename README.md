...
Current extension version: `0.2.14`
...
The popup should show `Extension build 0.2.14`. No command, background server, API key, or account is needed after installation.
